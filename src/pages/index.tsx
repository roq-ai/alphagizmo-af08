...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`AlphaGizmo`}</title>

        <meta
          name="description"
          content="AlphaGizmo - Empowering sales executives to craft compelling emails and marketing messages, tailored to their audience and enriched with industry insights for maximum impact."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1560250056-07ba64664864?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYWxlc3xlbnwwfHx8fDE2OTg5NDgwMTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`AlphaGizmo - Empowering sales executives to craft compelling emails and marketing messages, tailored to their audience and enriched with industry insights for maximum impact.`}
            </Text>
            <Box
